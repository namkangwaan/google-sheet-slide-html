...
ไฟล์แบบฝึกมี 6 ชีต คือ `Start_Here`, `Classroom`, `HR_Roster`, `Sales_Data`, `Regex_Data` และ `Assignments` ข้อมูลในชีตหลักเริ่มที่แถว 5 ช่องคำตอบใน `Assignments` คอลัมน์ E เว้นว่างไว้ให้ผู้เรียนกรอกเอง โจทย์มี 30 ข้อ แบ่งเป็น HR 10 ข้อ, Sales (SD) 10 ข้อ และ Regex (RG) 10 ข้อ ทุกข้อมีสูตรเฉลยพร้อมเหตุผล
